...
2. Download the latest `FluxCap-Setup-1.5.0.exe` installer.
...
3.  **Scan for Leftovers:** Use the "Moderate" or "Advanced" scan to find and safely remove remaining files and registry entries (specifically checking for old `%AppData%\unofficial-fluxer-client` folders).
